...
print("a well-lit white hallway. As you walk towards the engine room, the hallway gradually changes to metallic, pipes")
print("overhead and metal grating on the floor and walls. A crew of three is hardly enough to finance fancy white")
print("panelling for the entire ship, you suppose. The door to the engine room opens as you approach and you see BENJAMIN")
print("working. He is wearing the standard mechanic attire - dark green pants and light green shirt. While most of his")
print("hair has balded off already, the little that remains is brown. BENJAMIN looks up as you enter the room and waves.")
input()
...
if eng_dec1.upper() == 'A':
    ...
    print("[BENJAMIN]")
    print("Can't complain! As a native Iowan, as long as there's food on the table, life's good... even if the food is space")
    print("rations.")
    input()
    ...
    if eng_dec1_1.upper() == 'A':
        ...
        if eng_dec1_2.upper() == 'A' or eng_dec1_2.upper() == 'B':
            ...
            if eng_dec1_2.upper() == 'A':
                print("BENJAMIN eyes you for a moment before bursting into tears. You're surprised and immediately hug him. After a")
                print("few seconds, BENJAMIN wipes his eyes and looks up.")
                input()
            ...
            if player['ch_1']['outcome'] == 'failure':
                ...
                print("to feel. BENJAMIN laughs nervously; his voice sounds strained, and he quickly wipes away another tear. Could he")
                print("really mean what he said? How would he know? You search your memory but, as usual, it comes up empty-handed. If")
                print("you can't trust the Ship AI... your thoughts wander to VERONICA and how little information she was willing to")
                print("share... can you trust either of them? You absently dismiss BENJAMIN and start the long, cold walk back to your")
                print("quarters.")
                input()
            ...
            if player['ch_1']['outcome'] == 'minor_reveal':
                print("[*STORY*]")
                print("Headache? Hazy memory?? That sounds uncomfortably like what you were feeling this morning... and still continue")
                print("to feel. VERONICA mentioned that she had a headache, too. Your heart drops. Somehow, all crew members awoke with")
                print("a headache this morning... and at least you and BENJAMIN are having trouble remembering things. You consider")
                print("telling BENJAMIN about VERONICA... but you decide to keep quiet. Your attention is brought back to the present")
                print("as BENJAMIN laughs nervously; his voice sounds strained, and he quickly wipes away another tear. Could he really")
                print("mean what he said about the ship? How would he know? You search your memory but, as usual, it comes up empty-")
                print("handed. If you can't trust the Ship AI... you slowly begin walking back to your quarters, your stomach in knots.")
                input()
            
            if player['ch_1']['outcome'] == 'major_reveal':
                print("[*STORY*]")
                print("Your jaw drops. Headache? Memory loss?? That's exactly what VERONICA said she was experiencing, and that you've")
                print("been feeling all day. Your heart starts racing. Somehow, all crew members awoke today with no recollection of who")
                print("they really are... and head pain. Suddenly, you feel a lot less safe than you felt before. Your thoughts tiptoe")
                print("cautiously, hesitantly, to the Ship AI... could BENJAMIN really mean what he just said? How would he know? You")
                print("search your memory but, as usual, it comes up empty-handed. If you can't trust SHIP... you absently dismiss")
                print("BENJAMIN and slowly start walking back to your quarters. This is going to require some thinking, if you can stop")
            ...
            if player['ch_1']['outcome'] == 'full_reveal':
                ...
                print("they really are... and head pain. Suddenly, you feel a lot less safe than you felt before. Your thoughts tiptoe")
                print("cautiously, hesitantly, to the Ship AI... could BENJAMIN really mean what he just said? How would he know? You")
                print("search your memory but, as usual, it comes up empty-handed. If you can't trust the Ship AI... your thoughts turn")
                print("to VERONICA and her work for an antidote. Will she finish in time? Can SHIP even be trusted in allowing VERONICA")
                print("to finish? You absently dismiss BENJAMIN and slowly start walking back to your quarters. This is going to require")
                print("some thinking, if you can stop your hands from shaking first.")
                input()
...
if intimidate == True:
    ...
    if intimidate_outcome < [75]:
        ...
        input()
        print("[BENJAMIN]")
        print("Nothing is going on, Commander. Back in Ohio, we're all just used to being this friendly. I'm not sure what to")
        print("say, honestly!")
        input()
        ...
        if eng_dec1_1.upper() == 'A':
            ...
            if intimidate_outcome2 < [50]:
                ...
                input()
                print("[BENJAMIN]")
                print("I'm sorry, Commander. I haven't been fully honest. I... I've been having a really strange day. I... I'm having")
                print("trouble remembering really simple things. Where I'm from. Why I'm here, what I'm supposed to be doing. I've got")
                print("such a crazy headache, I can barely think straight. But I won't let it affect my work, Commander.")
                input()
                ...
                if player['ch_1']['outcome'] == 'failure':
                    ...
                    print("thought, you're not sure. Your thoughts wander back to VERONICA and how little information she was willing to")
                    print("share...")
                    input()
                ...
                if player['ch_1']['outcome'] == 'minor_reveal':
                    ...
                    print("to feel. VERONICA mentioned that she had a headache, too. Your heart drops. Somehow, all crew members awoke with")
                    print("a headache this morning... and at least you and BENJAMIN are having trouble remembering things. You consider")
                    print("telling BENJAMIN about VERONICA... but you decide to keep quiet. You dismiss BENJAMIN and slowly begin walking")
                    print("back to your quarters, a knot in your stomach.")
                    input()
                
                if player['ch_1']['outcome'] == 'major_reveal':
                    print("[*STORY*]")
                    print("Now it's your turn for your mouth to drop. Headache? Memory loss?? That's exactly what VERONICA said she was")
                    print("experiencing, and that you've been feeling all day. Your heart starts racing. Somehow, all crew members awoke")
                    print("today with no recollection of who they really are... and head pain. Suddenly, you feel a lot less safe than you")
                    print("felt before. You absently dismiss BENJAMIN and slowly start walking back to your quarters. This is going to")
                ...
                if player['ch_1']['outcome'] == 'full_reveal':
                    ...
                    print("experiencing, and that you've been feeling all day. Your heart starts racing. Somehow, all crew members awoke")
                    print("today with no recollection of who they really are... and head pain. Suddenly, you feel a lot less safe than you")
                    print("felt before, and your thoughts rush back to VERONICA and her work on an antidote. It can't come quickly enough...")
                    print("but will it come in time? You absently dismiss BENJAMIN and slowly start walking back to your quarters. This is")
            ...
            if intimidate_outcome2 >= [50]:
                ...
                input()
                print("[BENJAMIN]")
                print("Sorry, Commander. I'm just have a slow day. Woke up with a big headache... been misspeaking. Accidentally wrote")
                print("down the wrong screws in the engine report earlier, too. Sorry I'm slurring things.")
                input()
                print(f"[{player['name']}]".upper())
                print("Cut the crap, BENJAMIN. Give me the truth.")
                input()
                ...
                if player['ch_1']['outcome'] == 'failure':
                    print("[*STORY*]")
                    print("You're convinced BENJAMIN is full of it, but there's nothing more to be said. You noticed he mentioned a")
                    print("headache... that sounds an awful like what you woke up with this morning. You want to press him further but")
                    print("it won't do any good. Can *anyone* on this damn crew be honest and straightforward with you? A dark shiver")
                    print("passes down your heart as you entertain the thought of there being two imposters on board...")
                    input()
                        
                if player['ch_1']['outcome'] == 'minor_reveal':
                    print("[*STORY*]")
                    print("A headache?? That sounds uncomfortably like what you were feeling this morning... and still continue to feel.")
                    print("VERONICA mentioned that she had a headache, too. Your heart drops. Somehow, all crew members awoke with a")
                    print("headache this morning... You consider telling BENJAMIN about VERONICA but you decide to keep quiet. You dismiss")
                    print("BENJAMIN and slowly begin walking back to your quarters, a knot in your stomach.")
                    input()
                ...
                if player['ch_1']['outcome'] == 'major_reveal':
                    ...
                    print("A headache?? That sounds uncomfortably like what you were feeling this morning... and still continue to feel.")
                    print("VERONICA mentioned that she had a headache, too. Your heart drops. Somehow, all crew members awoke with a")
                    print("headache this morning... and at least you and VERONICA also have memory loss. BENJAMIN's memory doesn't sound")
                    print("too great, either, but getting the facts wrong sounds like something an imposter would do, too. Suddenly, you")
                    print("feel a lot less safe than you felt before. You absently dismiss BENJAMIN and slowly start walking back to your")
                    print("quarters. This is going to require some thinking...")
                    input()
                ...
                if player['ch_1']['outcome'] == 'full_reveal':
                    ...
                    print("headache this morning... and at least you and VERONICA also have memory loss. BENJAMIN's memory doesn't sound")
                    print("too great, either, but getting the facts wrong sounds like something an imposter would do, too. Suddenly, you")
                    print("feel a lot less safe than you felt before. Your thoughts dart back to VERONICA and her work on an antidote.")
                    print("It can't come quickly enough... but will it come in time? You absently dismiss BENJAMIN and slowly start")
                    print("walking back to your quarters. This is going to require some thinking... if you can stop your hands from")
                    print("shaking first.")
                    input()
    ...
    if intimidate_outcome >= [75]:
        ...
        input()
        print("[BENJAMIN]")
        print("Sorry, Commander. I'm just have a slow day. I don't appreciate your tone of voice... that would never fly back")
        print("in Iowa. Now if you excuse me, I'd like to get back to work. Sorry.")
        input()
        ...
        if player['ch_1']['outcome'] == 'failure':
            print("[*STORY*]")
            print("You're convinced BENJAMIN is full of it, but there's nothing more to be said. You want to press him further but")
            print("it won't do any good. Can *anyone* on this damn crew be honest and straightforward with you? A dark shiver")
            print("passes down your heart as you entertain the thought of there being two imposters on board...")
            input()
        ...
        if player['ch_1']['outcome'] == 'minor_reveal':
            print("[*STORY*]")
            print("You're convinced BENJAMIN is full of it, but there's nothing more to be said. You want to press him further but")
            print("it won't do any good. Does he have a headache like VERONICA and you? You watch him for a few moments - he")
            print("actually turns around and starts working and humming a tune... the nerve! - but it's hard to tell. He's already")
            print("acting like he's been dismissed, but you dismiss him anyway and slowly begin walking back to your quarters.")
            input()
            
        if player['ch_1']['outcome'] == 'major_reveal':
            print("[*STORY*]")
            print("You're convinced BENJAMIN is full of it, but there's nothing more to be said. You want to press him further but")
            print("it won't do any good. Does he have a headache like VERONICA and you? Can he remember anything? It's unsettling")
            print("that you and VERONICA have headaches and memory loss but it doesn't seem like BENJAMIN does... or does he? You")
            print("watch him for a few moments - he actually turns around and starts working and humming a tune... the nerve! - but")
            print("it's hard to tell. He's already acting like he's dismissed, but you dismiss him anyway and slowly begin walking")
            print("back to your quarters.")
            input()   
        ...
        if player['ch_1']['outcome'] == 'full_reveal':
            ...
            print("that you and VERONICA have headaches and memory loss but it doesn't seem like BENJAMIN does... or does he? You")
            print("watch him for a few moments - he actually turns around and starts working and humming a tune... the nerve! - but")
            print("it's hard to tell. VERONICA's memory antidote can't come fast enough. BENJAMIN is already acting like he's")
