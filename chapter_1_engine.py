...
if eng_dec1.upper() == "A":
    print()
    print("[*STORY*]")
    print("You step carefully towards BENJAMIN, hiding behind machinery as you squint at what he's holding. It appears to be")
    print("some sort of tablet that he's reading... though it is hard to tell.")
    input()
    ...
    if eng_dec1_1.upper() == "A":
        ...
        if sneak_outcome < [25]:
            print()
            print("[FAILURE]")
            print("You step on a loose wrench, which echoes in the room. BENJAMIN spins around, his eyes wide in alarm. The")
            print("tablet instantly goes blank.")
            input()
            ...
            print("[*STORY*]")
            print("The conversation continues awkwardly for another minute before you excuse yourself. You stand outside the")
            print("the engine room for a few moments before silently heading back to your quarters.")
            input()
