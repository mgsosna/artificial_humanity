...
print("monitoring system: I cannot take video or images of the rooms or halls and then search for anomalies. The intruder has")
print("likely induced temporary amnesia in you to prolong the time it can attack me. It has erased its signature from my")
print("consciousness, rendering it effectively invisible to me.")
input()
