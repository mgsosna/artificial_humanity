########################################################################################################
# ARTIFICIAL HUMANITY
# Chapter 3: back in your quarters
#
# Matt Grobis
########################################################################################################
# Load modules
...
if player['ch_2']['outcome'] in ['kill_hide', 'kill_lock']:
    end_state = 'killer_second'

# You totally failed at getting any info
elif player['ch_1']['outcome'] == 'failure' and player['ch_2']['outcome'] == 'failure':
    end_state = 'failure'    
    
# You know everyone has headaches
elif player['ch_1']['outcome'] == 'minor_reveal' and player['ch_2']['outcome'] in ['minor_reveal', 'major_reveal']:
    all_headaches = True
  
elif player['ch_1']['outcome'] in ['minor_reveal', 'major_reveal'] and player['ch_2']['outcome'] == 'minor_reveal':
    all_headaches = True
    
# You know everyone has headaches + amnesia
elif player['ch_1']['outcome'] == 'major_reveal' and player['ch_2']['outcome'] == 'major_reveal':
    all_amnesia = True
    
# You know not to trust SHIP
elif (player['ch_1']['room'] == 'engine' and player['ch_1']['outcome'] == 'full_reveal') or (player['ch_2']['room'] == 'engine' and player['ch_2']['outcome'] == 'full_reveal'):
    distrust_ship = True

# You know VERONICA is working on antidote
elif (player['ch_1']['room'] == 'life' and player['ch_1']['outcome'] == 'full_reveal') or (player['ch_2']['room'] == 'life' and player['ch_2']['outcome'] == 'full_reveal'):
    antidote = True
    
# You got some weird mix of info
else:
    mixed_info = True
...
if end_state in ['killer_first', 'killer_second']:
    print("[*STORY*]")
    print("Your footsteps are purposeful, brisk as you walk towards your quarters. Head high, back straight... presentation is")
    print("important, after all, even if half your crew is lying in pieces in the engine room.")
    input()

# Failure - can't escape going to room
if end_state == 'failure':
    print("[*STORY*]")
    print("Your footsteps are slow, disappointed as you walk towards your quarters. Despite your efforts, there's not much to think")
    print("about. Your conversations with BENJAMIN and VERONICA yielded nothing. You truly don't know how to talk to people, it")
    print("seems. Hopefully SHIP will have answers.")
    input()
...
if all_amnesia == True:
    ...
    if walk_dec.upper() == 'B':
        print()
        print("[*STORY*]")
        print("You decide not to head back to your quarters, but you have nowhere to be... so you just stand there. You try")
        print("to think, but your mind is still fuzzy. Come on, think... what to do, what to do...")
        input()
        print("[*STORY*]")
...
if distrust_ship == False:
    ...
    input()
    print("[SHIP AI]")
    print("Good morning, Commander. Status report: Danger. I estimate the intruder will break through my firewall in 0.149 hours.")
    print("I have been unable to counteract the attack. Probability of resisting intruder... 0.000000000000000000000000000000018%.")
    print("Preparations must be made for failure. Cryogenic escape pods are still active and I advise abandoning ship.")
    input()
    ...
    if end_state == 'killer_second':
        print("[SHIP AI]")
        print("From my readings of BENJAMIN's heartbeat and the elevation of yours at the time of his death, I deduce that you killed")
        print("BENJAMIN. Excellent idea, Commander. Unfortunately, my calculations determine that VERONICA should also have been")
        print("killed. VERONICA is the imposter. Probability: 99%.")
        input()
    ...
    if end_state == 'failure' or all_headaches == True or all_amnesia == True or mixed_info == True:
        ...
        if all_headaches == True:
            print(f"[{player['name']}]".upper())
            print("SHIP. I *did* learn something potentially valuable, however. Everyone on the crew awoke this morning with headaches...")
            print("both VERONICA and BENJAMIN revealed that when I spoke with them, and I've had a migraine all day. Do you know what")
            print("could be the cause?")
            input()
            print("[SHIP]")
            print("Processing...")
            input()
        ...
        if all_amnesia == True:
            print(f"[{player['name']}]".upper())
            print("SHIP. I *did* learn something potentially valuable, however. Everyone on the crew awoke this morning with headaches...")
            print("as well as with amnesia. Both VERONICA and BENJAMIN have it... and I do, too. Do you know what could be the cause?")
            input()
            print("[SHIP]")
            print("Processing...")
            input()
    ...
    if conv_dec1.upper() == 'A':
        ...
        input()
        print("[*STORY*]")
        print("As your vision slowly sharpens, you see nothing but space in the window in front of you. This shouldn't be happening.")
        print("Why aren't you waking up on Earth? What's going on?")
        input()
        print("[*STORY*]")
        print("Your questions are never answered as you slowly starve in the pod, choking on the recirculating carbon dioxide. Your")
        print("last thoughts, repeated endlessly, are whether you got in the right pod...")
        input()
        print()
        print()
        print()   
    ...
    if conv_dec1.upper() == 'C':
        ...
        input()
        print("[*STORY*]")
        print("Except... the door doesn't open. You're shocked. You can't remember anything of your past, but this seems to definitely")
        print("new: you feel like you've never experienced your door not opening - it should recognize the identifier chip in your")
        print("bicep. You feel a sinking feeling in your stomach. This can't be good.")
        input()
        print("[*STORY*]")
        print("You don't know the time, but this should be about when SHIP predicted it would be unable to fend off the attacker.")
        print("But why is your door locked? Did SHIP initiate a security lockdown before it lost control? Or is this something")
        print("the intruder is doing? You listen carefully, but the door was designed to muffle all noise on either side of it:")
        print("no way to tell what's going on out there. You sit back on your bed and try to think this one through but you have")
        print("such a headache...")
        input()
        print("[*STORY*]")
        print("You can't stop thinking about how all crew members awoke today with headaches. How could this have happened? If there")
        print("was an imposter, why wouldn't they have just killed you? Could you have misread BENJAMIN or VERONICA? You hold your")
        print("head in your hands and close your eyes... there has to be a way out of this...")
        input()
        print("...")
        input()
        print("[*STORY*]")
        print("An hour passes... then two... then twelve. You're locked in your room and your headache is growing worse. When's")
        print("the last time you ate? You're starting to get thirsty. Your thoughts are slowly becoming morbid but you try to not")
        print("think about it... SHIP still isn't responding, and your laser knife was useless against the door.")
        input()
        print("...")
        input()
        print("[*STORY*]")
        print("It's been days. SHIP never responded to you, the door is still locked, and you can't hear anything outside the room.")
        print("Gravity has stayed normal, and you can still breathe... but you're so delirious that you wish the end would come sooner.")
        print("You can barely think straight...")
        input()
        print("...")
        input()
        print("[*STORY*]")
        print("You've been drifting in and out of consciousness for the last day. Were you always in the room? You feel the trickles")
        print("of memories returning to you, but you can't tell the difference between reality and dreams of a starved brain. Your")
        print("vision stopped working, but you find yourself mysteriously devoid of hunger or thirst this close to the end...")
        input()
        print("[*STORY*]")
