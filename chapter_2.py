...
if player['ch_1']['outcome'] == 'massive_failure':
    ...
    input()
    print("[*STORY*]")
    print("Head hurts, but you able to focus. You... you are in Life Support Systems. Attacked carbon scrubber but... VERONICA")
    print("stopped you. You slowly raise a hand to head. Hair crusty with... with blood. Hurts. But alive.")
    input()
    print("[*STORY*]")
    print("What do now?")
    ...
    if hurt_dec.upper() == "B" or hurt_dec2.upper() == "A":
        print()       
        print("[*STORY*]")
        print("Need to go to Engine Room. Talk to BENJAMIN. Find imposter. Avoid VERONICA. She maybe is imposter. Need... to go...")
        print("Engine Room.")
        input()
...
input()
print("[SHIP AI]")
print("Good morning, Commander. Status report: Vulnerable. I estimate the intruder will break through my firewall in 1.508")
print("hours. I am attempting to counteract the attack, but it is a machine form with at most 11.714% similarity to existing")
print("programs in my library. I have lost connection to Earth and three databases have become corrupted. Shields in Zone D")
print("are compromised and I detected a sharp drop in air pressure, likely from a meteorite (88% confidence). Would you like")
print("a coffee?")
input()
print(f"[{player['name']}]".upper())
...
if player['ch_1']['room'] == 'engine':      
    ...
    if player['ch_1']['outcome'] in ['kill_lock', 'kill_hide', 'kill_nothing']:
        ...
        if conv_dec1.upper() == 'A':
            print()
            print("[SHIP AI]")
            print("From her vital signs, she appears mildly distressed but not at levels compatible with suspicion of death. It")
            print("is probable she is the imposter. Once she is eliminated and my consciousness is restored, I will chart a course")
            print("for Earth.")
            input()
    ...
    if player['ch_1']['outcome'] not in ['kill_lock', 'kill_hide', 'kill_nothing']:
        ...
        if conv_dec1.upper() == 'B' and player['ch_1']['outcome'] == 'failure':
            ...
            print("Officer is consistent with the hypothesis that BENJAMIN is an imposter, as well as the hypothesis that BENJAMIN is")
            print("not. Caution is advised.")
            input()
            print("[SHIP]")
            print("VERONICA is currently in Life Support Systems. There are only 1.499 hours remaining. I will now restore all resources")
        ...
        if conv_dec1.upper() == 'B' and player['ch_1']['outcome'] == 'full_reveal':
            ...
            input()
            print("[SHIP]")
            print("Probability that BENJAMIN is the imposter has increased to 100%. Lying to the Commanding Officer and attempting to")
            print("sabotage the Ship AI is consistent with the hypothesis that BENJAMIN is an imposter.")
            input()
            print("[SHIP]")
            print("Calculating probability of new alternative hypothesis...")
            input()
            print("[SHIP]")
            print("New hypothesis presented: two imposters are present onboard. Probability: 88.4119%. The complexity of the attack on my")
            print("consciousness indicates the potential for more than one actor. Recommendation: investigate VERONCIA, kill BENJAMIN.")
            input()
            print("[SHIP]")
            print("VERONICA is currently in Life Support Systems. There are only 1.496 hours remaining. I will now restore all resources")
            print("to fighting off the attack.")
            input()
...
if player['ch_1']['room'] == 'life' and player['ch_1']['outcome'] != 'massive_failure':
    ...
    if conv_dec1.upper() == 'A':
        print()
        print("[SHIP AI]")
        print("As you command... captain. BENJAMIN is currently in the Engine Room. There are only 1.501 hours remaining. I will")
        print("now restore all resources to fighting off the attack.")
        input()
    ...
    if conv_dec1.upper() == 'B' and player['ch_1']['outcome'] == 'failure':
        ...
        print("Officer is consistent with the hypothesis that VERONICA is an imposter, as well as the hypothesis that VERONICA is")
        print("not. Caution is advised.")
        input()
        print("[SHIP]")
    ...
    if conv_dec1.upper() == 'B' and player['ch_1']['outcome'] == 'full_reveal':
        ...
        input()
        print("[SHIP]")
        print("Probability that VERONICA is the imposter has increased to 100%. Lying to the Commanding Officer and attempting to")
        print("sabotage the Ship AI is consistent with the hypothesis that VERONICA is an imposter.")
        input()
        print("[SHIP]")
        print("Calculating probability of new alternative hypothesis...")
        input()
        print("[SHIP]")
        print("New hypothesis presented: two imposters are present onboard. Probability: 88.4119%. The complexity of the attack on my")
        print("consciousness indicates the potential for more than one actor. Recommendation: investigate BENJAMIN, kill VERONICA.")
        input()
        print("[SHIP]")
